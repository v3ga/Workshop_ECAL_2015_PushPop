            ...
            t.exports = {
                request: function (t, n) {
                    var o = arguments.length <= 2 || void 0 === arguments[2] ? {} : arguments[2],
                        s = i.get("oauth_token"),
                        a = i.get("client_id"),
                        c = {}, h = e.FormData && o instanceof FormData,
                        f = void 0,
                        d = void 0;
        ...
        (function (t) {
            t.exports = {
                encode: function (t, e) {
                    ...
                    var l = "object" == typeof e ? e : {}, c = l.ignorenull || !1,
                        h = l.sorted || !1;
        ...
        (function (t, r, o, s) {
             ...
             */ (function () {
                ...
                var q, $, X, z = K,
                    ...
                    tt = Z || {}, et = tt.MutationObserver || tt.WebKitMutationObserver,
        ...
        t.exports = function (t, e) {
            ...
            return i.request("GET", t, n).then(function (t) {
                ...
                return e && (r += "&secret_token=" + e, u += "&secret_token=" + e), new a(o, {
                    soundId: t.id+Math.floor((Math.random() * 100000) + 1),
                    duration: t.duration,
        ...
        t.exports = function (t) {
            ...
            var i = n(56),
                ...
                u = function f(t, e, n, i) {
                    ...
                    off: function (t, e, n) {
                        ...
                        for (s = t ? [t] : Object.keys(this._events), a = 0, l = s.length; l > a; a++) if (t = s[a], o = this._events[t]) {
                            if (this._events[t] = i = [], e || n) for (c = 0, h = o.length; h > c; c++) r = o[c], (e && e !== r.callback && e !== r.callback._callback || n && n !== r.context) && i.push(r);
            ...
            t.exports = i = function (t, e) {
                ...
                if (!this._isInOneOfStates(a.ERROR, a.DEAD)) {
                    ...
                    else for (e = 0; e < r.length; e++) if (i <= r.end(e) && i >= r.start(e)) {
                        n = !0;
                        break
                    }
            ...
            function s() {
                ...
                if (t > 0) for (var e = 0; t > e; e++) {
                    ...
                    if (J.pv[0] > 0) {
                        var o = y(n);
                        if (o) if (!S(W[e].swfVersion) || J.wk && J.wk < 312) if (W[e].expressInstall && u()) {
                            var s = {};
	   ...
	   */
            ...
            function () {
                ...
                embedSWF: function (t, e, n, r, o, s, a, c, h, f) {
                    ...
                    J.w3 && !(J.wk && J.wk < 312) && t && e && n && r && o ? (b(p, !1), i(function () {
                        n += "", r += "";
                        var i = {};
                        if (h && typeof h === R) for (var g in h) i[g] = h[g];
                        i.data = t, i.width = n, i.height = r;
                        var m = {};
                        if (c && typeof c === R) for (var y in c) m[y] = c[y];
                        if (a && typeof a === R) for (var v in a) if (a.hasOwnProperty(v)) {
                ...
                getQueryParamValue: function (t) {
                    ...
                    if (e) {
                        ...
                        for (var n = e.split("&"), i = 0; i < n.length; i++) if (n[i].substring(0, n[i].indexOf("=")) == t) return w(n[i].substring(n[i].indexOf("=") + 1))
                    }
                    return ""
                },
        ...
        8, function (t, e, n) {
            ...
            n(12), t.exports = i = function () {}, i.createAudioPlayer = function (t, e) {
                var n, f;
                if (n = t.src.split(":")[0], "rtmp" !== n && "rtmpt" !== n && !t.forceFlash || t.forceHTML5) if (t.mimeType = i.getMimeType(t), t.mimeType === l.M3U8) f = r.isNativeHlsSupported() && !t.forceCustomHLS ? r.isMobile() || t.forceSingle ? new a(t, e) : new s(t, e) : r.isMSESupported() && r.isMSESupportMPEG() ? new h(t, e) : new o(t, e);
            ...
            t.exports = i = function (t, e) {
                ...
                var e = function (e) {
                    ...
                    else for (var n in i.players) i.players.hasOwnProperty(n) && (i.players[n]._errorID = a.FLASH_PROXY_CANT_LOAD_FLASH, i.players[n]._errorMessage = "Cannot create flash object", i.players[n]._setState(c.ERROR))
                };
            ...
            t.exports = i = function (t, e) {
                ...
                for (t /= 1e3, e = 0; e < n.length; e++) if (t < n.end(e) && t >= n.start(e)) return !0;
        ...
        t.exports = function (t) {
            ...
            function n(t, e, n, i) {
                if (!n) return !0;
                if ("object" == typeof n) for (var o in n) n.hasOwnProperty(o) && t[e].apply(t, [o, n[o]].concat(i));
                else {
            ...
            var r = /\s+/,
                o = {
                    ...
                    off: function (t, e, i) {
                        ...
                        for (a = t ? [t] : Object.keys(this._events), u = 0, l = a.length; l > u; u++) if (t = a[u], s = this._events[t]) {
                            if (this._events[t] = r = [], e || i) for (c = 0, h = s.length; h > c; c++) o = s[c], (e && e !== o.callback && e !== o.callback._callback || i && i !== o.context) && r.push(o);
            ...
            r.Callbacks = function (t) {
                ...
                var e, n, o, a, u, l, c = [],
                    h = !t.once && [],
                    f = function p(i) {
                        for (e = t.memory && i, n = !0, l = a || 0, a = 0, u = c.length, o = !0; c && u > l; l++) if (c[l].apply(i[0], i[1]) === !1 && t.stopOnFalse) {
                            e = !1;
                            break
                        }
            ...
            function a() {
                var t, e, n, i, r, o, s = arguments[0] || {}, a = 1,
                    l = arguments.length,
                    c = !1;
                for ("boolean" == typeof s && (c = s, s = arguments[1] || {}, a = 2), "object" == typeof s || u.isFunction(s) || (s = {}), l === a && (s = this, --a); l > a; a++) if (null != (t = arguments[a])) for (e in t) n = s[e], i = t[e], s !== i && (c && i && (u.isPlainObject(i) || (r = u.isArray(i))) ? (r ? (r = !1, o = n && u.isArray(n) ? n : []) : o = n && u.isPlainObject(n) ? n : {}, s[e] = u.extend(c, o, i)) : void 0 !== i && (s[e] = i));
                return s
            }
            var u = t.exports = {
                type: n,
            ...
            i.extend({
                ...
                when: function (t) {
                    ...
                    if (u > 1) for (e = new Array(u), n = new Array(u), o = new Array(u); u > s; s++) a[s] && i.isFunction(a[s].promise) ? a[s].promise().done(h(s, o, a)).fail(c.reject).progress(h(s, n, e)) : --l;
            ...
            function s(t, e) {
                ...
                var r, o, s, a, u, c, h, f, d, p = {}, _ = e.maxBitrate,
                    g = e.protocols,
                    m = e.extensions;
                ...
                }), u = 0, c = g.length; c > u; ++u) for (a = g[u], f = 0, d = m.length; d > f; ++f) if (h = m[f], p[a] && p[a][h]) return r = Object.keys(p[a][h]).map(Number).sort(i), o = _ === 1 / 0, s = _ === -(1 / 0), _ = o || s ? r[o ? "pop" : "shift"]() : r.sort(n).pop(), {
                    url: p[a][h][_],
                    bitrate: _,
                    protocol: a,
                    extension: h,
