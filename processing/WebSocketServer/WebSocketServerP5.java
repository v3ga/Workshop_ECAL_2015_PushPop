...
public class WebSocketServerP5 implements WebSocketHandler {
  ...
  public WebSocketServerP5(PApplet theParent, int port, String socketname) {
    ...
    try {
      Class args[] = { 
        WebSocketConnection.class, String.class
      };
  ...
  public WebSocketConnection getWebSocketConnectionByIP(String ip)
  {
    for (WebSocketConnection c : connections)
    {
  ...
  {
    InetSocketAddress address = (InetSocketAddress) con.httpRequest().remoteAddress();
